...
class DatabaseFormatter(BaseFormatter):
    ...
    def write_output(self):
        ...
        attack_surface_to_insert = (self.source, 
                                    ...
                                    0,  #self.execution_paths_count,
                                    0,  #self.average_execution_path_length,
                                    0,  #self.median_execution_path_length,
        ...
        for c in self.nodes:
            nodes_to_insert.append(
                (new_attack_surface_id,
                 ...
                 0,  #self.get_descendants_entry_point_ratio(c),
                 0,  #self.get_descendants_exit_point_ratio(c),
                 0,  #self.get_ancestors_entry_point_ratio(c),
                 0,  #self.get_ancestors_exit_point_ratio(c),
                 0,  #self.get_descendant_entry_points_count(c),
                 0,  #self.get_descendant_exit_points_count(c),
                 0,  #self.get_ancestor_entry_points_count(c),
                 0,  #self.get_ancestor_exit_points_count(c),
